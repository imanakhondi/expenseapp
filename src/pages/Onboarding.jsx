  ...
  return (
    <div className=" w-[420px] h-[890px] flex flex-col  bg-white font-semibold">
      <div className=" flex items-center justify-center h-[630px] bg-[#EEF8F7] w-full clip-path-style">
        <div className=" h-[550px] border border-white rounded-full flex items-center justify-center absolute">
      ...
      <div className="h-[260px] w-full">
        ...
        <Link to="/panel/home">
          <button className=" bg-primary text-lg shadow-[0px_12px_19px_0px_#3e7c787d] font-semibold text-white w-80 rounded-full py-5 ">
            Get Started
          </button>
        </Link>
