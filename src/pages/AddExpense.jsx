...
const AddExpense = () => {
  ...
  return (
    <div className=" relative w-96 h-[790px] flex flex-col items-center bg-white font-semibold">
      ...
      {/* General Profile */}
      <div className=" absolute flex flex-col justify-between items-center top-40  mx-auto rounded-2xl h-[500px] p-3 bg-white text-[#666666] w-[350px] shadow-[0_10px_20px_0_#00000038]">
